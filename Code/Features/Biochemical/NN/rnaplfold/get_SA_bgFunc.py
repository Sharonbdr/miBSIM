...
def get_SA_bg(SEQUENCE_FILE, TEMP_FOLDER, OUTFILE, NUM_BG=200, NUM_PROCESSES=1, VIEPATH=None):
    ...
    SEQUENCES = pd.read_csv(SEQUENCE_FILE, sep='\t', chunksize=1)
    ...
    def get_RNAplfold(seq):
        ...
        shutil.copyfile('../../../Thermo/ViennaRNA/RNAplfold', temp_subfolder + '/RNAplfold')
        os.chmod(temp_subfolder + '/RNAplfold', 0o755)
        ...
        if VIEPATH is None:
            if platform.system()=="Windows":
                ...
                mycall = [temp_subfolder + '/RNAplfold', '-L', '40', '-W', '40', '-u', '12']
        else:
