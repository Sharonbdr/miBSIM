...
if __name__ == '__main__':
    ...
    shutil.copyfile(vienna_path + 'RNAplfold', temp_folder + 'RNAplfold')
    ...
    if not options.SKIP:
        ...
        for i in range(10):
            get_SA_bg(SEQUENCE_FILE = utldir + 'canon_'+options.MIRNAME+'_%d.txt'%i, TEMP_FOLDER = temp_folder,
                      OUTFILE = utldir + 'canon_'+options.MIRNAME+'_%d_bg_vals.txt'%i, VIEPATH = '')
    ...
    mycall = ['RNAplfold', '-L', '40', '-W', '80', '-u', '15']
