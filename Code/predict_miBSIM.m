...
bio_results_path='../Features/Biochemical/bio_output/';
...
int_features = add_bio_features(genes,base_output,bio_results_path, job_name); 

% predict Integrative model
int_pred = predict_Intmodel(int_features); 

save(sprintf('../../Output/Integrative_output_%s.mat',job_name),'int_pred');
...
writetable(predictions, sprintf('../../Output/%s_miBSIM_pred.txt',job_name), 'Delimiter', '\t');
